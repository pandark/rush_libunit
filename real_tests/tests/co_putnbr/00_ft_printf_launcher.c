...
/*   Updated: 2017/11/26 14:52:02 by ntoniolo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_printf_launcher(void)
{
	...
	load_test(&testlist, "print_wchar_preci_weight", 0,
									&ft_printf_print_wchar_preci_weight);
	load_test(&testlist, "print_p", 0, &ft_printf_print_p);
	load_test(&testlist, "null", 0, &ft_printf_null);
	load_test(&testlist, "print_s_null_preci", 0,
										&ft_printf_print_s_null_preci);
